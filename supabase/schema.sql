...
-- AI Coach chat messages (one thread per user per day)
...
create index if not exists coach_messages_user_date_idx on public.coach_messages (user_id, date, created_at);
